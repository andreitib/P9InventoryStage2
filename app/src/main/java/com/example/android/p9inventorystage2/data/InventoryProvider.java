...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORIES + "/#"
                , INVENTORY_ID);
    }
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that the amount is empty
        Integer amount = values.getAsInteger(InventoryEntry.COLUMN_AMOUNT);
        if (amount == null ) {
            throw new IllegalArgumentException("Product amount of items is empty");
        }
        ...
        // Check that the supplier phone number is entered
    ...
    private int updateInventory(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryEntry.COLUMN_AMOUNT)) {
            Integer amount = values.getAsInteger(InventoryEntry.COLUMN_AMOUNT);
            if (amount == null) {
                throw new IllegalArgumentException("Product amount of items is empty");
            }
